...
const profiles = [
  ...
  },
  {
    ...
    bgClass: 'bg-[#121214]',
    textClass: 'text-white',
    taglineClass: 'text-[#F0C674]',
    pillClass: 'bg-[#E54D2E] text-white shadow-[0_0_20px_rgba(229,77,46,0.4)]',
    btnClass: 'border-2 border-[#E8B84B] text-[#E8B84B] hover:bg-[#E8B84B]/20 hover:border-[#F0C674]',
    removeImageBackground: true,
  },
];
